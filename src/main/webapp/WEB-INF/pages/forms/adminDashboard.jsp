...
<head>
    ...
    <title>Admin Dashboard | Kronica</title>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active" href="/HealthManager/adminDashboard"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
<!--                         <li> -->
...
<!--                         </li> -->
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/HealthManager/data/findPatient">Find Patient</a>
                                </li>
                                <li>
