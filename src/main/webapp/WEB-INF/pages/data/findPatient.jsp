...
<head>
    ...
    <title>Find Patient | Kronica</title>
	        ...
	        success: function (users) {
	        	...
	        	if (users.users && users.users.length > 0){
        		  for (var i = 0; i < users.users.length; i++){
        			  ...
        			  str += "<option>" + user.first_name + " " + user.last_name + ", (" + user.email + ")</option>";
        	      }
	        	}
	        	else{
...
<!--                         </li> -->
						<li class="active">
                            <a href="#"><i class="fa fa-table fa-fw"></i> Data Navigation<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="/HealthManager/data/findPatient">Find Patient</a>
                                </li>
                                <li>
...
<!--                         </li> -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Find Patient</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                	<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                	<form role="form" method="post" action="viewPatient">
