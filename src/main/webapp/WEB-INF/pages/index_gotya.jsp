...
<head>
	...
	<meta charset="utf-8">
	<title>Kronica</title> 
	<meta name="description" content="Health Management tool"/>
	<meta name="author" content="Dipesh Mittal"/>
	<!-- end: Meta -->
...
<body>
	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			<div class="da-slide">
				<h2>Medical Monitor</h2>
				<p>Understanding and regulating your body and habit can do wonders to your life.</p>
				<a href="#" class="da-link">Read more</a>
				<div class="da-img"><img src="img/parallax-slider/twitter.png" alt="image01" /></div>
			</div>
			<div class="da-slide">
				<h2>Health Education </h2>
				<p>Best place to start being healthy is to learn about risks in your lifestyle and decide on tackling them.</p>
				<a href="#" class="da-link">Read more</a>
...
<!--       		</div> -->
	...
	<div id="copyright">
		...
		<div class="container">
			...
			<p>
				&copy; 2014, Kronica. <a href="http://bootstrapmaster.com" alt="Bootstrap Themes">Bootstrap Themes</a> designed by BootstrapMaster
			</p>
